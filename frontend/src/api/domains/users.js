...
export const userAPI = {
  ...
  batchAssignRoles: (data) => api.post('/users/batch/roles', data),
...
export const tenantAPI = {
  ...
  updateTenantModules: (tenantId, modules) => api.put(`/tenant-module-config/tenants/${tenantId}/modules`, { modules }),
};
