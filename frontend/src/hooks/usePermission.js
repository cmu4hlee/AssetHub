...
export const useCan = (module, action = 'view') => {
  ...
  const moduleRoles = {
    ...
    metrology: {
      ...
      delete: ['metrology_admin', 'quality_admin'],
    },
    quality: {
    ...
    acceptance: {
      ...
      edit: ['acceptance_admin'],
      delete: ['acceptance_admin'],
      approve: ['acceptance_admin'],
    ...
    transfer: {
      ...
      edit: ['transfer_admin'],
      delete: ['transfer_admin'],
      approve: ['transfer_admin'],
      complete: ['transfer_admin'],
    },
    inventory: {
      view: ['inventory_admin', 'asset_admin'],
      add: ['inventory_admin', 'asset_admin'],
      edit: ['inventory_admin'],
      delete: ['inventory_admin'],
      complete: ['inventory_admin'],
    },
    asset: {
    ...
    request: {
      view: ['maintenance_admin', 'maintenance_engineer', 'asset_admin'],
      add: ['maintenance_admin', 'maintenance_engineer', 'asset_admin'],
      edit: ['maintenance_admin', 'maintenance_engineer'],
      delete: ['maintenance_admin'],
      approve: ['maintenance_admin'],
    },
    workorder: {
