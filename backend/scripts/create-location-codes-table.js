...
async function createLocationCodesTable() {
  try {
    console.log('开始创建位置编码表...');
    ...
    `);
    console.log('✅ 位置编码表创建成功');

    console.log('✅ 位置编码表创建完成！');
    process.exit(0);
  } catch (error) {
...
if (require.main === module) {
  createLocationCodesTable();
}

module.exports = createLocationCodesTable;
